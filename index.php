...
<html lang="en">
    ...
    <body class="solar-energy-home">
                        ...
                        <div class="banner-solar-energy-inner">
                            <div class="wrapper">
                                ...
                                <h1 class="title skew-up">
                                    CREATING SUSTAINABLE <br> CLEAN ENERGY SOLUTIONS <br> FOR SOMALILAND
                                </h1>
                                <!-- <p class="disc skew-up">
                                    Proin a faucibus sodales sollicitudin fringilla ultricies penatibus
                                </p> -->
                                <div class="button-area ">
                                    <a href="aboutus.html" class="rts-btn btn-primary">More About Us</a>
                                    <a href="service.html" class="rts-btn btn-primary bg-w">Our Service</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="title-area-center">
                            <p class="pre skew-up">
                                <span> About</span> Solari Service
                            </p>
                        ...
                        <div class="single-service-start">
                            <div class="image-area">
                                <a href="service-details.html" class="thumbnail">
                                    <img src="assets/images/service/15.jpg" alt="service">
                                </a>
                                <div class="icon">
                            ...
                            <div class="inner-content">
                                ...
                                <p class="disc">Acinia phaselus tellus egstas into cursus urna suscpit vehicula otua pellentesque placerat</p>
                ...
                <div class="row pt--30 separator-Top rts-section-gapBottom">
                    <div class="col-lg-12">
                        <div class="service-solari-short-info">
                            <div class="call">
                                <p>Call us today: <a href="tel:+4733378901">+258-3269 125</a> <span>or</span></p>
                                <p>Email us: <a href="mailto:name@email.com">info@solar.pa.com</a></p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <!-- rts faq area start -->
        <div class="faq-section-start-solar rts-section-gapTop">
            <div class="container">
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            Solar energy is energy that is produced from the sun's light and heat. It is a renewable and clean source of energy that can be harnessed using solar panels.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                    ...
                    <div class="col-lg-6 pl--40">
                        <div class="faq-solari-image-area">
                            <div class="thumbnail-small">
                                <img src="assets/images/faq/04.png" alt="solar">
                            ...
                            <div class="thumbnail-large-bottom">
                                <img src="assets/images/faq/05.png" alt="solar">
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="expertiex-solar-inner">
                                ...
                                <div class="single-exp">
                                    ...
                                    <div class="info-wrapper">
                                        <h5 class="title">Professional Solar Experts</h5>
                                        <p class="dsic">
                                            Fusce condimentum mattis placerat odio donec lacus porta <br> torquent, mauris gravida rutrum
                                        </p>
                                    </div>
                                </div>
                                <!-- ingle end -->
                            ...
                            <div class="button-area">
                                ...
                                <div class="call-btn">
                                    ...
                                    <div class="info">
                                        ...
                                        <a href="#" class="title">+236-3256.21456</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="left-awesome-feedback-wrapper">
                            ...
                            <div class="single-awesome-feedback-area large">
                                <div class="wrapper">
                                    ...
                                    <p>Vivamus quisque lobortis placerat imperdiet class eros neque duisator mollis porttitor</p>
                                </div>
                            </div>
                            ...
                            <div class="single-awesome-feedback-area small">
                                <div class="wrapper">
                                    <h2>200+</h2>
                                    <h5 class="title skew-up">Handyman Solution</h5>
                                    <p>Viamus quique lobortis plarat imperdiet class eros</p>
                                </div>
                            </div>
                            <!-- single feedback area end -->
                        </div>
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-12 col-xl-6 padding-feedback-top-btm">
                                ...
                                <div class="awes-me-fun-f-content">
                                    <p class="disc skew-up">
                                        Dui maecenas tempus laoreet nec nullam fringilla luctusoi eros quam pellentesque cras dictum fermentum, conubia eu egestas velit netus dictumst.
                                    </p>
                            ...
                            <div class="col-lg-12 col-xl-6 pl--control-feedback">
                                <div class="thumbnail">
                                    <img src="assets/images/solution/04.png" alt="solution">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row mb--70">
                    <div class="col-lg-12">
                        ...
                        <div class="project-soalr-wrapper">
                            ...
                            <a href="#" class="rts-btn btn-primary">View All Projects</a>
                        </div>
                            ...
                            <div class="swiper mySwiper-h1-solari-product">
                                <div class="swiper-wrapper">
                                        ...
                                        <div class="rts-solar-single-product-one">
                                            ...
                                            <div class="inner-content">
                                                <a href="project-details.html">
                                                    <h5 class="title">Expanding The Solar Supply</h5>
                                                </a>
                                    ...
                                    <div class="swiper-slide">
                                        ...
                                        <div class="rts-solar-single-product-one">
                                            <a href="project-details.html" class="thumbnail">
                                                <img src="assets/images/project/18.jpg" alt="project">
                                            </a>
                                            <div class="inner-content">
                                                <a href="project-details.html">
                                                    <h5 class="title">Solar Chain Finance Program</h5>
                                                </a>
                                                <span>Building, Renovation</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="swiper-slide">
                                        ...
                                        <div class="rts-solar-single-product-one">
                                            <a href="project-details.html" class="thumbnail">
                                                <img src="assets/images/project/19.jpg" alt="project">
                                            </a>
                                            <div class="inner-content">
                                                <a href="project-details.html">
                                                    <h5 class="title">Smarter Ways to Manage EV</h5>
                                                </a>
                                                <span>Building, Renovation</span>
                                            </div>
                                        </div>
        ...
        <div class="rts-about-company-wrapper rts-section-gap bg_image">
            <div class="container">
                <div class="row g-24">
                    <div class="col-lg-12">
                        <div class="title-area-center">
                        ...
                        <div class="cpmpay-story-single-about">
                            ...
                            <div class="body">
                                ...
                                <a href="blog-details.html">
                                    <h5 class="title">Future mus faucibus vitae tempor primis auctor</h5>
                                </a>
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="cpmpay-story-single-about">
                            ...
                            <div class="body">
                                ...
                                <a href="blog-details.html">
                                    <h5 class="title">Story mus faucibus vitae tempor primis auctor</h5>
                                </a>
                                <a href="blog-details.html" class="rts-btn btn-border radious-0">
                                    Read Details<i class="fa-regular fa-arrow-up-right"></i>
                                </a>
                    ...
                    <ul class="mainmenu metismenu" id="mobile-menu-active">
                        <li class="has-droupdown">
                            ...
                            <ul class="submenu mm-collapse">
                                ...
                                <li><a class="mobile-menu-link" href="index.html">Home Page One</a></li>
                                <li><a class="mobile-menu-link" href="index-two.html">Home page Two</a></li>
                                <li><a class="mobile-menu-link" href="index-three.html">Home Page Three</a></li>
                                <li><a class="mobile-menu-link" href="index-Four.html">Home Page Four</a></li>
                                <li><a class="mobile-menu-link" href="index-Five.html">Home Page Five</a></li>
                            </ul>
                            <ul class="submenu mm-collapse">
                                <li><a href="#" class="tag">Onepage</a></li>

                                <li><a class="mobile-menu-link" href="one-page-one.html">Onepage One</a></li>
                                <li><a class="mobile-menu-link" href="one-page-two.html">Onepage Two</a></li>
                                <li><a class="mobile-menu-link" href="one-page-three.html">Onepage Three</a></li>
                                <li><a class="mobile-menu-link" href="one-page-four.html">Onepage Four</a></li>
                                <li><a class="mobile-menu-link" href="one-page-five.html">Onepage Five</a></li>
                            </ul>
                        </li>
                        <li class="has-droupdown">
                            ...
                            <ul class="submenu mm-collapse">
                                ...
                                <li class="has-droupdown third-lvl">
                                    ...
                                    <ul class="submenu-third-lvl mm-collapse">
                                        ...
                                        <li><a href="project-details-vedio.html"></a>Details Vedio</li>
