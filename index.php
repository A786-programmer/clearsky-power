                        ...
                        <div class="banner-solar-energy-inner">
                            <div class="wrapper">
                                <h1 class="title skew-up">
                                    Trusted Solar Solutions for Homes, Businesses, and Communities
                                </h1>
                                <p class="disc skew-up">
                                    We design, install, and maintain cost-effective solar systems for on and off-grid electricity
                                </p>
                                <div class="button-area ">
                                    <a href="get-quote.php" class="rts-btn btn-primary">Get Free Quote</a>
                                    <a href="javascript:void(0)" class="rts-btn btn-primary bg-w">See Our Projects</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="single-service-solari">
                            ...
                            <a href="javascript:void(0)">
                                <h5 class="title">Assessment & Design</h5>
                            </a>
                            <p class="disc">On-site Data + Optimized Systems</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="single-service-solari two">
                            <div class="icon-area">
                                <svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <path d="M25.664 19.4726C25.3235 19.6134 24.9856 19.7728 24.6598 19.9465L25.158 20.8811C25.4535 20.7235 25.7599 20.5789 26.0686 20.4514L25.664 19.4726Z" fill="#1F1F25" />
                                    <path d="M27.7879 18.8306C27.4258 18.9022 27.0632 18.9926 26.7101 19.0993L27.0167 20.1131C27.3367 20.0163 27.6653 19.9344 27.9934 19.8695L27.7879 18.8306Z" fill="#1F1F25" />
                                    <path d="M24.2936 21.3978L23.7068 20.5162C23.4 20.7204 23.0995 20.9422 22.8137 21.1753L23.4832 21.9959C23.7425 21.7844 24.0152 21.5831 24.2936 21.3978Z" fill="#1F1F25" />
                                </svg>
                            </div>
                            <a href="javascript:void(0)">
                                <h5 class="title">Installation</h5>
                            </a>
                            <p class="disc">Commercial, Residential, and Agricultural Projects</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                ...
                <div class="row mb--70">
                    <div class="col-lg-12">
                        ...
                        <div class="project-soalr-wrapper">
                            ...
                            <a href="projects.php" class="rts-btn btn-primary">View All Projects</a>
                        </div>
                ...
                <div class="row g-24">
                            ...
                            <div class="swiper mySwiper-h1-solari-product">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="rts-solar-single-product-one">
                                            <a href="projects.php" class="thumbnail">
                                                <img style="height:300px" src="imgs/projects/barwaqo-university/1.avif" alt="project">
                                            </a>
                                            <div class="inner-content">
                                                <a href="projects.php">
                                                    <h5 class="title">Hybrid Solar-Diesel System</h5>
                                                </a>
                                                <span>Barwaaqo University, 2021</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="swiper-slide">
                                        ...
                                        <div class="rts-solar-single-product-one">
                                            <a href="projects.php" class="thumbnail">
                                                <img style="height:300px" src="imgs/projects/mansoor-hotel/1.avif" alt="project">
                                            </a>
                                            <div class="inner-content">
                                                <a href="projects.php">
                                                    <h5 class="title">Hybrid Solar-Diesel System</h5>
                                                </a>
                                                <span>Mansoor Hotel, Burco, 2022</span>
                                            </div>
                                        </div>
                                        <!-- single product area end -->
                                    </div>
                                    <div class="swiper-slide">
                                        ...
                                        <div class="rts-solar-single-product-one">
                                            <a href="projects.php" class="thumbnail">
                                                <img style="height:300px" src="imgs/projects/horn-cable-tv/1.avif" alt="project">
                                            </a>
                                            <div class="inner-content">
                                                <a href="projects.php">
                                                    <h5 class="title">Grid-Tied Solar System</h5>
                                                </a>
                                                <span>Horn Cable TV, 2019</span>
                                            </div>
                                        </div>
                                        <!-- single product area end -->
                                    </div>
                                    <div class="swiper-slide">
                                        ...
                                        <div class="rts-solar-single-product-one">
                                            <a href="projects.php" class="thumbnail">
                                                <img style="height:300px" src="imgs/projects/abaarso-school/1.avif" alt="project">
                                            </a>
                                            <div class="inner-content">
                                                <a href="projects.php">
                                                    <h5 class="title">Hybrid Solar-Diesel System</h5>
                                                </a>
                                                <span>Abaarso School, 2016</span>
                                            </div>
                                        </div>
                                        <!-- single product area end -->
                                    </div>
                                    <div class="swiper-slide">
                                        ...
                                        <div class="rts-solar-single-product-one">
                                            <a href="projects.php" class="thumbnail">
                                                <img style="height:300px" src="imgs/projects/mansoor-hotel-hargeisa/1.avif" alt="project">
                                            </a>
                                            <div class="inner-content">
                                                <a href="projects.php">
                                                    <h5 class="title">Solar Water Heating and Outdoor Lighting</h5>
                                                </a>
                                                <span>Maansoor Hotel, Hargeisa</span>
                                            </div>
                                        </div>
                                        <!-- single product area end -->
                                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="text-center">
                            <h6 class="title">Switch to solar today. Save money. Gain reliability. Protect the environment</h6>
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="single-review-area-soalri">
                                            ...
                                            <p class="dsic">ClearSky Power cut our irrigation costs dramatically</p>
                                            <div class="author-area">
                                                <img src="assets/images/testimonials/08.png" alt="image" class="authoe">
                                                <h6 class="title">Farmer</h6>
                                                <span>Puntland</span>
                                                <div class="star-area">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="single-review-area-soalri">
                                            <img src="assets/images/testimonials/07.png" alt="testimonaials" class="quote">
                                            <p class="dsic">Our factory now runs reliably with solar + storage</p>
                                            <div class="author-area">
                                                <img src="assets/images/testimonials/08.png" alt="image" class="authoe">
                                                <h6 class="title">Factory Owner</h6>
