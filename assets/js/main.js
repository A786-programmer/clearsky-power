    ...
    swiperActivation: function (e) {
      ...
      $(document).ready(() => {
        ...
        var thumbs = new Swiper('.rts-dynamic-thumb', {
          ...
          watchSlidesProgress: true, // Required to correctly sync thumbs
        });
      
        // Initialize the main slider and connect it to the thumbs slider
        var slider = new Swiper('.banner-slider-nine', {
          ...
          thumbs: {
            swiper: thumbs, // Connects the main slider with the thumbnail slider
          },
        });
      });
