                    ...
                    <div class="header-top-m">
                        <div class="left">
                            ...
                            <div class="inf">
                                ...
                                <a href="mailto:info@clearsky-power.com">info@clearsky-power.com</a>
                            </div>
                        </div>
                        <div class="right">
                            ...
                            <nav>
                                <ul>
                                    ...
                                    <li class="has-dropdown">
                                        <a class="nav-link" href="javascript:void(0)"> AboutUs </a>
                                        <ul class="submenu">
                                    ...
                                    <li class="has-dropdown">
                                        ...
                                        <ul class="submenu">
                                            <li><a href="commercial-and-residential.php">Commercial & Residential</a></li>
                                            <li><a href="farming-and-agriculture.php">Farming & Agriculture</a></li>
                                            <li><a href="mini-grids.php">Mini Grids</a></li>
                                        </ul>
                                    </li>
                                    ...
                                    <li><a class="nav-link" href="contact-us.php"> ContactUs </a></li>
                                </ul>
                            </nav>
                        </div>
