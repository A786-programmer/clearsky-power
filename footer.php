<div class="rts-footer-one  footer-bg-two bg-four">
    <div class="container">
            ...
            <div class="col-lg-12 plr_sm--15">
                <div class="single-footer-one-wrapper two">
                    <div class="single-footer-component first">
                        <a href="index.php" class="logo-area-footer">
                            <img src="logo.png" alt="logo" width="150px">
                        </a>
                        <div class="body mt--45">
                            <p class="disc">Reliable solar solutions for the Horn of Africa</p>
                            <div class="rts-social-style-one">
                                <ul>
                                    <li><a href="https://www.facebook.com/CSPsolarenergy/" target="_blank"><i class="fa-brands fa-facebook-f"></i></a></li>
                                    <!-- <li><a href=""><i class="fa-brands fa-twitter"></i></a></li> -->
                                    <!-- <li><a href=""><i class="fa-brands fa-youtube"></i></a></li> -->
                                    <li><a href="https://www.linkedin.com/company/clearsky-power/posts/" target="_blank"><i class="fa-brands fa-linkedin-in"></i></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="body">
                            <div class="footer-contact-wrapper-2">
                                ...
                                <div class="contact-single">
                                    ...
                                    <div class="info-content">
                                        <a href="javascript:void(0)">
                                            <h6 class="title">Jidka Nawawi</h6>
                                        </a>
        ...
        <div class="row pb--20 pt--20 border-top-copyright">
            <div class="col-lg-12">
                <div class="copyright-area-two five">
                    <div class="left">
                        <p>Copyright <?= date('Y') ?>. All Rights Reserved.</p>
                    </div>
                    <div class="right">
                        <p>Designed & Developed By <a href="https://hakamtechsol.com/" target="_blank">HakamTechSol</a></p>
                    </div>
                </div>
            </div>
        </div>
