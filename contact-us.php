...
<html lang="en">
    ...
    <body class="solar-energy-home">
                ...
                <div class="row align-items-center g-0 bg-appoinment">
                    <div class="col-md-6">
                        <div class="map-area-wrapper">
                            <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d14604.908726737911!2d90.4219536!3d23.77492315!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2sbd!4v1679901838243!5m2!1sen!2sbd" width="600" height="650" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                        </div>
                    </div>
                    <div class="col-md-6 pl--30">
                        <h3 class="title animated fadeIn">Talk to our team today and start your solar journey</h3>
                        <form method="post" class="appoinment-form contact-page-form">
                            ...
                            <select required name="service">
                                <option data-display="Select">Select a Service</option>
                                <option value="Commercial & Residential">Commercial & Residential</option>
                                <option value="Farming & Agriculture">Farming & Agriculture</option>
                                <option value="Mini Grids">Mini Grids</option>
                            </select>
                            <textarea required name="message" placeholder="Type Your Message" required></textarea>
        ...
        <div class="rts-contact-info-area mt--60 mb--40">
            <div class="container">
                <div class="row g-24">
                    <div class="col-md-4">
                        <div class="single-contact--info-wrapper">
                            ...
                            <div class="content">
                                ...
                                <a href="mailto:info@clearsky-power.com">
                                    <h5 class="title under-line">info@clearsky-power.com</h5>
                                </a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="single-contact--info-wrapper">
                            ...
                            <div class="content">
                                ...
                                <a href="tel:+252 (0)63 7652037">
                                    <h5 class="title">+252 (0)63 7652037</h5>
                                </a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="single-contact--info-wrapper">
                            ...
                            <div class="content">
                                ...
                                <a href="https://www.google.com/maps" target="_blank">
                                    <h5 class="title">Maansoor Area, Hargeisa</h5>
                                </a>
                            </div>
                        </div>
                    </div>
